...
/**
 * Custom exception class for handling errors related to the scraping process.
 * This extends the base Exception class, making it a checked exception.
 */
public class ScrapeException extends Exception {
	/**
	 * Constructs a new ScrapeException with the specified detail message.
	 *
